...
class ProfileController {
    ...
    let oktaAuth = OktaAuth(baseURL: URL(string: "http://notTheRealURL.com")!,
                            clientID: "123456789",
                            redirectURI: "storysquad://notTheRealOne")
    
    private(set) var authenticatedUserProfile: Profile?
    private(set) var profiles: [Profile] = []
    
    // TODO: Use your own deployment endpoint here
    private let baseURL = URL(string: "http://alsoNotReal.com")!
