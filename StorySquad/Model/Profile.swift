...
/// Note from Cora: this data structure will not be used - it is for generic labs projects
/// Refactor ProfileController to use StorySquad profile data models instead
